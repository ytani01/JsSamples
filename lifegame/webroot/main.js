...
class BaseObj {
    ...
    constructor(id, update=false) {
        ...
        console.log(`${this.id}: this.el=${this.el}`);
...
class Field {
    ...
    constructor(cols, rows) {
        ...
        this.label_generation = new BaseObj("generation");
        this.generation = 0;

        this.label_life_count = new BaseObj("life-count");
        this.life_count = 0;
